...
var passwordCheckOld = function()
{
    ...
    {
        stringOutput = "Your password must be at least 8 characters long." //this is to check if the password is long enough
    }
    else
    {
        ...
        {  
            ...
            {
                stringOutput = "This password is not unique enough. Please try again."; //this is to see if their password is in the list of bad passwords
    ...
    if(stringOutput === "")
    {
        stringOutput= "Great password!"; //this outputs if they have a unique password
    }
    $("output").value = stringOutput; //this sends the outputs to the dom
