...
var generate = function () 
{
	...
	// this checks if intCount is a valid number
	if(isNaN(intCount) || intCount < 1 || intCount > 100 )
	{
		alert("Number is not valid. Choose a number between 1 and 100");
		stringOutput = "";
		

	}
	else
	//this is the loop that creates the fibonacci numbers
	{
		while(intCount>2)
		{
			k = i+j;
