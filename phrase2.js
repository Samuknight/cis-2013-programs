...
{   
    ...
    if(stringEntry === "")
    {
        alert("Please enter a phrase and then press the button");
    }
    else
    {
        var intVowels = 0;
        ...
        {
            if(stringEntry.charAt(intCount)==="A" || stringEntry.charAt(intCount)==="E" || stringEntry.charAt(intCount)==="O" ||stringEntry.charAt(intCount)==="I" || stringEntry.charAt(intCount)==="U")
            {
                intVowels++
            }
        }
    ...
    else
    {
        ...
        {
            stringReverse = stringReverse + stringEntry.charAt(intCount);
        }
    }
